...
# ငါတို့ဘာတွေတည်ဆောက်နေကြလဲ

ဒီသင်ခန်းစာမှာတော့ Docker Compose ကိုသုံးပြီး production-quality အပြည့်ရှိတဲ့ three-tier application stack တစ်ခုလုံးကို အစကနေစပြီး တည်ဆောက်သွားမှာ ဖြစ်ပါတယ်။ လိုင်းတစ်ကြောင်းချင်းစီက ဘာလုပ်လဲ၊ ဘာကြောင့်ဒီလိုရေးရလဲဆိုတာ သေချာနားလည်စေဖို့ ဖိုင်တိုင်းမှာ မှတ်ချက်တွေ ရှင်းပြပေးထားပါတယ်။
...
multi-stage Dockerfile တစ်ခုကို သုံးခြင်းအားဖြင့် production image ကို ပေါ့ပါးအောင် (lean) ထိန်းသိမ်းထားနိုင်ပါတယ် — dev tools တွေ မပါဘူး၊ source maps တွေ မပါဘူး၊ dependency tree တစ်ခုလုံးအတွက် `node_modules` လည်း ပါလာမှာ မဟုတ်ပါဘူး:
...
ဒီသင်ခန်းစာမှာတော့ အောက်ပါအချက်တွေပါဝင်တဲ့ production-quality three-tier stack တစ်ခုကို တည်ဆောက်ခဲ့ပြီးဖြစ်ပါတယ်:
- **Multi-stage Dockerfile** — လိုအပ်တဲ့ build artifacts တွေကိုပဲ သုံးထားတဲ့ ပေါ့ပါးတဲ့ runtime image
- **Nginx reverse proxy** — static files တွေကို ဖြေရှင်းပေးတယ်၊ Node.js ဆီကို proxy လုပ်ပေးတယ်၊ security headers နဲ့ gzip တွေကို ပေါင်းထည့်ပေးတယ်
- **Migration service** — API မစတင်ခင်မှာ Prisma migrations တွေကို တစ်ကြိမ်တည်း အတိအကျ run ပေးတယ် (`condition: service_completed_successfully` ကို သုံးပြီး)
- **Startup ordering** — `db → cache → migrate → api → nginx` ဆိုပြီး တစ်ခုချင်းစီက တကယ့် health checks တွေကို စောင့်ဆိုင်းလုပ်ဆောင်ကြတယ်
- **Override pattern** — `docker-compose.dev.yml` က hot reload၊ local clients တွေအတွက် exposed ports တွေနဲ့ profiles တွေမှတဆင့် သုံးလို့ရတဲ့ optional dev tools တွေကို ပေါင်းထည့်ပေးတယ်
- **Security** — database ကို internet ပေါ် တိုက်ရိုက်မထုတ်ထားဘူး၊ non-root container user ကို သုံးထားတယ်၊ Redis ကို password နဲ့ ကာကွယ်ထားတယ်

နောက်လာမယ့် သင်ခန်းစာမှာတော့ development၊ staging နဲ့ production environment တွေအကြား environment variables နဲ့ secret management တွေကို ကျွမ်းကျင်အောင် လေ့လာသွားမှာ ဖြစ်ပါတယ်။