...
import { ChevronLeft, ChevronRight, CheckCircle, Sparkles, GitPullRequest, MessageSquare, Bug } from "lucide-react";
...
export function LessonNav({
  ...
  return (
    <div className="mt-16 space-y-8">
      {/* Prev / Next Buttons */}
      <div className="pt-8 border-t border-slate-200 dark:border-white/[0.08] flex flex-col sm:flex-row items-center justify-between gap-4">
        {/* Prev Button */}
        {prevLesson ? (
          <Link
      ...
      {/* Community Contribution & Feedback Bar */}
      <div className="p-4 rounded-xl border border-slate-200 dark:border-white/[0.06] bg-slate-50/50 dark:bg-white/[0.01] flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-muted-foreground">
        <div className="flex items-center gap-2">
          <GitPullRequest className="w-4 h-4 text-blue-500" />
          <span>Found a typo or want to improve this lesson?</span>
        </div>
