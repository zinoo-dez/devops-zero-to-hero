...
import { COURSES_MY } from './courses.my';
...
export const COURSES: Course[] = [
  ...
  },
  {
    ...
    longDescription:
      "Modern cloud infrastructure cannot be configured manually through web consoles. Infrastructure as Code (IaC) with Terraform enables automated, version-controlled, reproducible cloud architectures. In this course, you will learn HashiCorp Configuration Language (HCL), managing state safely with remote backends, writing modular code, handling configuration drift, and automating deployment pipelines.",
    level: "Intermediate",
    duration: "4.5 hours",
    lessonCount: 8,
    icon: "Boxes",
    ...
    prerequisites: ["linux-command-line", "git-github"],
    learningObjectives: [
      "Understand the benefits of Infrastructure as Code and declarative resource management",
      "Write clean HashiCorp Configuration Language (HCL) with variables, outputs, and locals",
      "Configure providers for cloud and local hypervisors",
      "Manage remote state securely using AWS S3 and DynamoDB state locking",
      "Structure maintainable, reusable infrastructure modules with inputs and validation",
      "Detect and resolve infrastructure drift with terraform refresh and import",
      "Automate terraform plan & apply inside GitHub Actions CI/CD workflows",
    ],
    lessons: [
      { slug: "01-what-is-iac", title: "Why Infrastructure as Code & Terraform Architecture", duration: "25 min", order: 1 },
      ...
      { slug: "05-reusable-modules", title: "Creating Reusable, Production-Grade Infrastructure Modules", duration: "35 min", order: 5 },
      ...
      { slug: "08-automated-iac-pipeline", title: "Automated Terraform Plan & Apply in GitHub Actions", duration: "40 min", order: 8 },
    ],
    featured: true,
    order: 8,
    hasFullContent: true,
  },
  {
    ...
    longDescription:
      "You cannot fix what you cannot see. Modern distributed systems require full-stack observability. In this course, you will master Prometheus metrics collection and the PromQL query language, build executive & engineer dashboards in Grafana, aggregate container logs with Promtail and Loki, and configure actionable alert routes with Alertmanager.",
    level: "Intermediate",
    duration: "4.5 hours",
    lessonCount: 8,
    icon: "LineChart",
    ...
    learningObjectives: [
      "Understand the 3 pillars of observability: Metrics, Logs, and Distributed Traces",
      "Deploy and configure Prometheus server scraping targets and exporters",
      "Write real-world PromQL expressions for CPU, memory, error rates, and 99th percentiles",
      "Build visual, interactive dashboards in Grafana with auto-refresh and variables",
      "Aggregate container and system logs using Grafana Loki and Promtail",
      "Configure Alertmanager routing, deduplication, and Slack/Discord notifications",
      "Understand distributed tracing concepts and OpenTelemetry instrumentation",
    ],
    lessons: [
      { slug: "01-observability-pillars", title: "The 3 Pillars of Observability (Metrics, Logs, Traces)", duration: "25 min", order: 1 },
      { slug: "02-prometheus-architecture", title: "Prometheus Architecture, Scraping & Time-Series DB", duration: "30 min", order: 2 },
      { slug: "03-promql-mastery", title: "PromQL Mastery: Rates, Histograms, and Quantiles", duration: "35 min", order: 3 },
      { slug: "04-node-exporter-cAdvisor", title: "System & Container Exporters (Node Exporter, cAdvisor)", duration: "30 min", order: 4 },
      { slug: "05-grafana-dashboards", title: "Designing High-Impact Dashboards in Grafana", duration: "35 min", order: 5 },
      { slug: "06-loki-log-aggregation", title: "Centralized Container Logging with Loki & Promtail", duration: "35 min", order: 6 },
      { slug: "07-alertmanager-alerts", title: "Alertmanager: Alert Rules, Deduplication & Slack Routing", duration: "35 min", order: 7 },
      { slug: "08-opentelemetry-tracing", title: "Distributed Tracing Essentials with OpenTelemetry", duration: "35 min", order: 8 },
    ],
    featured: true,
    order: 9,
    hasFullContent: true,
  },
  {
    ...
    longDescription:
      "Security is not an afterthought or an obstacle — it is an automated quality gate. In this course, you will master DevSecOps practices: scanning code for vulnerabilities and leaked credentials in CI/CD, scanning container base images with Trivy, signing immutable container artifacts with Sigstore Cosign, managing secrets with HashiCorp Vault, and hardening Kubernetes with RBAC and NetworkPolicies.",
    level: "Intermediate",
    duration: "4.5 hours",
    lessonCount: 8,
    icon: "ShieldAlert",
    ...
    learningObjectives: [
      "Understand Shift-Left security principles and the DevSecOps lifecycle",
      "Run automated SAST and secret leak detection (Gitleaks, Semgrep) in CI/CD pipelines",
      "Scan container images for CVE vulnerabilities with Trivy and break builds on critical flaws",
      "Digitally sign and verify container images using Sigstore Cosign",
      "Store and inject secrets securely without hardcoding or plain text exposure",
      "Harden Linux servers: non-root users, SSH key authentication, and UFW firewall rules",
      "Enforce least-privilege access in Kubernetes with RBAC, ServiceAccounts & NetworkPolicies",
    ],
    lessons: [
      { slug: "01-shift-left-security", title: "Shift-Left Security & The DevSecOps Mindset", duration: "25 min", order: 1 },
      { slug: "02-static-analysis-sast", title: "Automated SAST & Secret Leak Scanning in CI/CD", duration: "30 min", order: 2 },
      { slug: "03-vulnerability-scanning-trivy", title: "Container & Filesystem CVE Scanning with Trivy", duration: "35 min", order: 3 },
      { slug: "04-container-signing-cosign", title: "Supply Chain Security: Signing Images with Cosign", duration: "35 min", order: 4 },
      { slug: "05-secret-management", title: "Secret Management with HashiCorp Vault & Sealed Secrets", duration: "35 min", order: 5 },
      ...
      { slug: "08-runtime-security-falco", title: "Runtime Threat Detection & Auditing with Falco", duration: "35 min", order: 8 },
    ],
    featured: true,
    order: 10,
    hasFullContent: true,
  },
  {
    ...
    longDescription:
      "GitOps represents the modern gold standard for Kubernetes delivery where Git is the single source of truth. In this course, you will install and configure ArgoCD, declare applications declaratively with Custom Resource Definitions, manage multi-environment manifests using Kustomize and Helm, enforce automated drift detection and self-healing, and execute progressive Canary rollouts with Argo Rollouts.",
    level: "Advanced",
    duration: "5 hours",
    lessonCount: 8,
    icon: "Boxes",
    ...
    learningObjectives: [
      "Understand GitOps core principles: Declarative state, version control, automated pull syncing",
      "Deploy and configure ArgoCD in Kubernetes with CLI and Web UI access",
      "Define applications using Application and ApplicationSet Custom Resource Definitions (CRDs)",
      "Manage environment overrides cleanly with Kustomize overlays and Helm parameters",
      "Enable automated sync policies, pruning of deleted resources, and cluster self-healing",
      "Execute zero-downtime Canary and Blue-Green deployments with Argo Rollouts",
    ],
    lessons: [
      ...
      { slug: "04-kustomize-helm-gitops", title: "Managing Multi-Environment Manifests with Kustomize & Helm", duration: "35 min", order: 4 },
      { slug: "05-sync-strategies-drift", title: "Sync Policies: Auto-Sync, Pruning & Self-Healing", duration: "35 min", order: 5 },
      { slug: "06-app-of-apps-pattern", title: "The App-of-Apps Pattern & Multi-Cluster Deployments", duration: "35 min", order: 6 },
      { slug: "07-progressive-delivery-rollouts", title: "Progressive Delivery with Argo Rollouts (Canary & Blue-Green)", duration: "40 min", order: 7 },
